...
export const CHANGELOG = [
  {
    ...
    date: "2026-09-20",
    changes: [
      "全面优化透明主屏幕小组件表现，解绑固定系统背景并采用 15% 黄金微透暗底托底，平衡纯色与高频壁纸。",
      "重塑透明模式文字对比度体系，核心标题与数值采用通透纯白并加入柔和暗影，防止在浅色高反差区域被局部吞噬。",
      "进度条底槽升级为通透白半透槽，正常用量状态色升级为清透苹果亮绿，消除同色系杂色与塑料感。",
      "透明模式下彻底隐藏右下角品牌水印，消除背景暗影污斑；全尺寸多账号 Dashboard 与单账号组件统一质感。",
    ],
  },
  {
    version: "1.7.0",
    date: "2026-09-19",
    changes: [
      "新增文件级加密备份与恢复功能，采用 PBKDF2-HMAC-SHA256 密钥派生与 AES-256-GCM 强加密保护凭据。",
      "支持导出所有已授权账号 Keychain 凭据、各平台默认账号指向以及全局和小组件偏好设置。",
      "恢复备份采用增量合并模式，同账号原地受控覆盖并清理过期残留字段，恢复后即时同步主题与小组件缓存。",
      "备份与恢复交互加入操作忙碌锁与进行中授权互斥检查，保障数据写入状态一致性。",
    ],
  },
  {
    version: "1.6.3",
