...
const DEMO_ACCOUNTS: DemoAccount[] = [
  ...
  {
    id: "demo_claude_enterprise",
    provider: "claude",
    title: "enterprise@claude.demo",
    planLabel: "Claude Enterprise",
    windows: [
      {
        id: "five_hour",
        name: "five_hour",
        label: "5 小时",
        usedPercent: 24,
        resetOffsetMs: 3 * 3_600_000 + 32 * 60_000,
      },
      {
        id: "weekly",
        name: "weekly",
        label: "每周",
        usedPercent: 37,
        resetOffsetMs: 6 * 86_400_000 + 4 * 3_600_000,
      },
    ],
    resetCredits: null,
  },
    ...
    windows: [
      {
        ...
        label: "5 小时",
        usedPercent: 58,
        resetOffsetMs: 1 * 3_600_000 + 15 * 60_000,
      },
      {
        id: "weekly",
        name: "weekly",
  ...
  {
    id: "demo_cursor_business",
    provider: "cursor",
    title: "business@cursor.demo",
    planLabel: "Business",
    windows: [
      {
        id: "auto",
        ...
        label: "Auto",
        usedPercent: 47,
        resetOffsetMs: 15 * 86_400_000 + 6 * 3_600_000,
      },
      {
        id: "total",
        name: "total",
  ...
  {
    id: "demo_cursor_enterprise",
    provider: "cursor",
    title: "enterprise@cursor.demo",
    ...
    windows: [
      {
        ...
        label: "Auto",
        usedPercent: 15,
        resetOffsetMs: 21 * 86_400_000 + 3 * 3_600_000,
      },
      {
        id: "total",
        name: "total",
    ...
    windows: [
      {
        ...
        label: "5 小时",
        usedPercent: 78,
        resetOffsetMs: 1 * 3_600_000 + 42 * 60_000,
      },
      {
        id: "weekly",
        name: "weekly",
  ...
  {
    id: "demo_kimi_andante",
    provider: "kimi",
    title: "andante@kimi.demo",
    planLabel: "Andante",
    windows: [
      {
        id: "five_hour",
        ...
        label: "5 小时",
        usedPercent: 64,
        resetOffsetMs: 2 * 3_600_000 + 8 * 60_000,
      },
      {
        id: "weekly",
        name: "weekly",
        label: "每周",
        usedPercent: 52,
        resetOffsetMs: 3 * 86_400_000 + 7 * 3_600_000,
      },
    ],
    resetCredits: null,
  },
  {
    id: "demo_kimi_allegretto",
    provider: "kimi",
    title: "allegretto@kimi.demo",
    ...
    windows: [
      {
        ...
        label: "5 小时",
        usedPercent: 36,
        resetOffsetMs: 3 * 3_600_000 + 25 * 60_000,
      },
      {
        id: "weekly",
        name: "weekly",
        label: "每周",
        usedPercent: 44,
        resetOffsetMs: 4 * 86_400_000 + 5 * 3_600_000,
      },
    ],
    resetCredits: null,
  },
    ...
    windows: [
      {
        ...
        label: "5 小时",
        usedPercent: 12,
        resetOffsetMs: 4 * 3_600_000 + 30 * 60_000,
      },
      {
        id: "weekly",
        name: "weekly",
        label: "每周",
        usedPercent: 21,
        resetOffsetMs: 6 * 86_400_000 + 1 * 3_600_000,
      },
    ],
    resetCredits: null,
  },
    ...
    windows: [
      {
        ...
        label: "AI Credits",
        usedPercent: 55,
        resetOffsetMs: 14 * 86_400_000 + 3 * 3_600_000,
      },
      {
        id: "chat",
        name: "chat",
  ...
  {
    id: "demo_copilot_business",
    provider: "copilot",
    title: "business@github.demo",
    planLabel: "Business",
    windows: [
      {
        id: "credits",
        ...
        label: "AI Credits",
        usedPercent: 70,
        resetOffsetMs: 9 * 86_400_000 + 8 * 3_600_000,
      },
      {
        id: "chat",
        name: "chat",
  ...
  {
    id: "demo_copilot_enterprise",
    provider: "copilot",
    title: "enterprise@github.demo",
    planLabel: "Enterprise",
    windows: [
      {
        id: "credits",
        ...
        label: "AI Credits",
        usedPercent: 25,
        resetOffsetMs: 20 * 86_400_000 + 5 * 3_600_000,
      },
      {
        id: "chat",
        name: "chat",
    ...
    windows: [
      {
        ...
        label: "5 小时",
        usedPercent: 82,
        resetOffsetMs: 1 * 3_600_000 + 20 * 60_000,
      },
      {
        id: "weekly",
        name: "weekly",
        label: "每周",
        usedPercent: 90,
        resetOffsetMs: 2 * 86_400_000 + 10 * 3_600_000,
      },
    ],
    resetCredits: null,
  },
    ...
    windows: [
      {
        ...
        label: "5 小时",
        usedPercent: 60,
        resetOffsetMs: 2 * 3_600_000 + 48 * 60_000,
      },
      {
        id: "weekly",
        name: "weekly",
        label: "每周",
        usedPercent: 47,
        resetOffsetMs: 4 * 86_400_000 + 1 * 3_600_000,
      },
    ],
    resetCredits: null,
  },
    ...
    windows: [
      {
        ...
        label: "5 小时",
        usedPercent: 9,
        resetOffsetMs: 4 * 3_600_000 + 33 * 60_000,
      },
      {
        id: "weekly",
        name: "weekly",
        label: "每周",
        usedPercent: 18,
        resetOffsetMs: 6 * 86_400_000 + 5 * 3_600_000,
      },
    ],
    resetCredits: null,
  },
  ...
  {
    id: "demo_minimax_starter",
    provider: "minimax",
    title: "starter@minimax.demo",
    planLabel: "Starter",
    windows: [
      {
        id: "five_hour",
        ...
        label: "5 小时",
        usedPercent: 74,
        resetOffsetMs: 1 * 3_600_000 + 50 * 60_000,
      },
      {
        id: "weekly",
        name: "weekly",
        label: "每周",
        usedPercent: 83,
        resetOffsetMs: 2 * 86_400_000 + 9 * 3_600_000,
      },
    ],
    resetCredits: null,
  },
  {
    id: "demo_minimax_plus",
    provider: "minimax",
    title: "plus@minimax.demo",
    planLabel: "Plus",
    windows: [
      {
        id: "five_hour",
        ...
        label: "5 小时",
        usedPercent: 56,
        resetOffsetMs: 2 * 3_600_000 + 28 * 60_000,
      },
      {
        id: "weekly",
        name: "weekly",
  ...
  {
    id: "demo_minimax_ultra",
    provider: "minimax",
    title: "ultra@minimax.demo",
    planLabel: "Ultra",
    windows: [
      {
        id: "five_hour",
        ...
        label: "5 小时",
        usedPercent: 14,
        resetOffsetMs: 4 * 3_600_000 + 16 * 60_000,
      },
      {
        id: "weekly",
        name: "weekly",
