...
const REGISTRY_KEY = "ai_usage_claude_account_registry_v1";
...
function secretKey(profileId: string, field: string): string {
  return `ai_usage_claude_profile_${profileId}_${field}`;
}
...
export function listAccounts(): ClaudeAccountProfile[] {
  return getAccountRegistry().accounts;
}
export function resolveProfile(
  profileId?: string | null,
): ClaudeAccountProfile | null {
