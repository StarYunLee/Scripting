...
import type { ProviderUsageCore } from "./contracts";

export const PROVIDER_USAGE_REGISTRY = {
  codex: {
...
} satisfies Record<ProviderId, ProviderUsageCore>;

export function getProviderUsage(provider: ProviderId): ProviderUsageCore {
  return PROVIDER_USAGE_REGISTRY[provider];
}
