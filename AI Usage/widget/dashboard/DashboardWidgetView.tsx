...
import {
  ...
  shortWindowLabel,
  smallVisibleLimit,
  widgetDisplaySize as fallbackWidgetDisplaySize,
  widgetLayoutSize,
  type DashboardRow,
} from "./model";
...
function widgetDisplaySize(family: string): { width: number; height: number } {
  try {
    const display = (Widget as {
    ...
    /* Fall back to the documented family dimensions. */
  }
  return fallbackWidgetDisplaySize(family);
}
