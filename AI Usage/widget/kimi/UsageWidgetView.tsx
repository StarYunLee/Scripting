...
function modelFor(result: UsageResult): Model {
  ...
  return {
    ...
    weekly:
      ...
      null,
    planLabel: snapshot?.planLabel || snapshot?.planType || "Kimi Code",
    resetLabel: "重置",
    resetExpiration: formatResetDate(snapshot?.weekly?.resetAt || null),
...
export function UsageWidgetView({ result, family }: Props) {
  ...
  if (small) {
    ...
    return (
      ...
      >
        ...
        >
          <PlanBadge provider="kimi" label={model.planLabel} size="small" />
          <Spacer minLength={0} />
          <Text
            fontDesign="default"
            fontWidth="standard"
  ...
  return (
    ...
    >
      ...
      >
        <PlanBadge provider="kimi" label={model.planLabel} />
        <Spacer />
        <Text
          fontDesign="default"
          fontWidth="standard"
