...
import type { LimitWindow, UsageResult } from "../../providers/minimax/types";
...
export function UsageWidgetView(props: Props) {
  ...
  const planLabel = snapshot?.planLabel || snapshot?.planType || "MiniMax";
  ...
  if (isSmall)
    return (
      <DualQuotaSmallView
        ...
        provider="minimax"
        planLabel={planLabel}
        watermarkPath="assets/watermark-minimax.png"
