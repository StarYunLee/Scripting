...
function Watermark({ size }: { size: number }) {
  return (
    <Image
      filePath={`${Script.directory}/assets/watermark-antigravity.png`}
      resizable
      scaleToFit
    ...
    return (
      ...
      >
        ...
        <HStack
          ...
          padding={{ leading: 12, trailing: 12, top: 37 }}
        >
          <Text
            font={14}
            fontWeight="bold"
        ...
        <VStack
          ...
          padding={{ leading: 12, trailing: 12, top: 115 }}
        >
          <SingleInfoRow
            icon="clock"
            label="更新时间"
...
export function UsageWidgetView({
  ...
  let smallFirstTitle: string;
  let smallSecondTitle: string;
