...
<table>
  <tr>
    <td align="center" width="33%"><img src="assets/github-stars-preview-stars.jpeg" alt="GitHub Stars 收藏仓库页预览" /></td>
    <td align="center" width="33%"><img src="assets/github-stars-preview-lists.jpeg" alt="GitHub Stars 列表页预览" /></td>
    <td align="center" width="33%"><img src="assets/github-stars-preview-settings.jpeg" alt="GitHub Stars 设置页预览" /></td>
  </tr>
</table>

面向 [Scripting App](https://scriptingapp.github.io/) 的非官方 GitHub Stars 管理应用。在 iPhone 上浏览已加星仓库、维护自定义列表，并查看个人资料、贡献热力图与常用语言。
...
- 个人资料卡展示 Stars、Lists、Followers、Following，以及 GitHub 主页钉选仓库
- 多年度贡献热力图与常用语言比例条
...
- **钉选仓库**：只读展示 GitHub 主页最多 6 个钉选仓库，点击后在 App 内预览。仓库名过长时单行截断。

## 数据来源

数据来自 GitHub REST 与 GraphQL API，用于读取已登录账号的 Stars、Lists、个人资料、贡献日历与钉选仓库，并在确认后写入 Star 与列表变更。
...
本项目仅用于管理本人 GitHub 账号的 Stars 与列表。请自行评估第三方脚本、Token 权限和接口变更带来的风险，并遵守 GitHub 与 Scripting App 的服务条款。项目不保证接口永久可用，也不对数据延迟、权限失败、限流或服务端策略变化承担责任。
