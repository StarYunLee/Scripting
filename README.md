...
统一查看 Codex、Grok、Claude、Antigravity、Cursor、Kimi Code、GitHub Copilot、Z.ai（智谱）与 MiniMax 多账号用量的应用，支持 Small / Medium / Large 主屏幕小组件、按账号布局、固定剩余额度显示，以及快捷指令 / App Intent 刷新。
